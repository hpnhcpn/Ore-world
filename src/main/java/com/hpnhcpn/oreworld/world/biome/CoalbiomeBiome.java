...
public class CoalbiomeBiome extends OreWorldModElements.ModElement {
	public static Biome biome;

	public CoalbiomeBiome(OreWorldModElements instance) {
		super(instance, 2);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(Blocks.COAL_ORE.getDefaultState(),
				...
				event.getRegistry().register(biome.setRegistryName("ore_world:coalbiome"));
			}
		}
	}

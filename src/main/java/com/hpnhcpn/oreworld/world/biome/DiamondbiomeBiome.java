...
public class DiamondbiomeBiome extends OreWorldModElements.ModElement {
	public static Biome biome;

	public DiamondbiomeBiome(OreWorldModElements instance) {
		super(instance, 7);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(Blocks.DIAMOND_ORE.getDefaultState(),
				...
				event.getRegistry().register(biome.setRegistryName("ore_world:diamondbiome"));
			}
		}
	}

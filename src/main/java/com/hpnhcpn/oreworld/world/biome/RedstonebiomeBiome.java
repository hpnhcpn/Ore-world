...
public class RedstonebiomeBiome extends OreWorldModElements.ModElement {
	public static Biome biome;

	public RedstonebiomeBiome(OreWorldModElements instance) {
		super(instance, 4);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(Blocks.REDSTONE_ORE.getDefaultState(),
				...
				event.getRegistry().register(biome.setRegistryName("ore_world:redstonebiome"));
			}
		}
	}
